...
show_plots = st.toggle("Show Scatter-plots")
...
# Scatter plot
    fig = px.scatter(
        ...
        x="Age",
        y="BloodPressure",
        color="Outcome",          # 0 = Healthy, 1 = Diabetic
        title="Blood Pressure Trends by Age",
        labels={"Outcome": "Health Status"}  # optional: nicer label
    )
